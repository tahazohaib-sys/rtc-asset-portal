...
st.markdown(
    """
    <style>
    /* Remove Streamlit black top header */
    ...
    /* Hide any stray first text input (old big white pill above header) */
    ...
    /* Selected nav: white card with black text */
    ...
    /* KPI stat cards – centered with value on second line */
